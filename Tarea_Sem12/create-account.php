...
<div class="container">
	...
	echo "<div class='alert alert-warning mt-4' role='alert'>
					<p>Email ya existe en Base de Datos.</p>
					<p><a href='login.html'>Por favor loguearse aqui</a></p>
				</div>";
	} else {	
	...
	*/
	...
	if (mysqli_query($conn, $query)) {
		...
		<a class='btn btn-outline-primary' href='login.html' role='button'>Loguearse</a></div>";		
		} else {
